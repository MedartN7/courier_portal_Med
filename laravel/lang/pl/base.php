...
return [
    ...
    */
    ...
    "details_rodo" => "Szczegóły: ",
    "accept_rodo_details" => "RODO",
    "accept_rodo_policy" => "Regulamin",
    ...
    "message_message_regex" => "Dopuszczalna ilość znaków 500.",
    ...
    "custom_min_age" => "Musisz mieć co najmniej 18 lat, aby się zarejestrować.",
];